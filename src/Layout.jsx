            ...
            <div className="px-4 py-3 border-b border-slate-700/50">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button type="button" className="w-full flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors">
                    <div
                ...
                <DropdownMenuContent align="start" sideOffset={4} className="w-56 z-[60]">
                  {companies.map(c => (
